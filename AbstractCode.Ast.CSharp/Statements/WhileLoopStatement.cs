...
using WhileLoopStatementBase = AbstractCode.Ast.Statements.WhileLoopStatement;

namespace AbstractCode.Ast.CSharp.Statements
{
    public class WhileLoopStatement : WhileLoopStatementBase
    {
        public WhileLoopStatement()
        {
        }

        public WhileLoopStatement(Statement body, Expression condition)
            : base(condition)
        {
            Body = body;
        }
